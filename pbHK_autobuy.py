...
from settings import (
    ...
    BirthYear, BirthMonth, BirthDay, multi_CVV2Num    
)

def login():
    WebDriverWait(driver, 2).until(
        expected_conditions.presence_of_element_located((By.ID, 'j_username'))
    )
    ...
    WebDriverWait(driver, 20).until(
        expected_conditions.element_to_be_clickable((By.ID, "login"))
    )
...
def main():
    ...
    前往購物車
    """
    driver.get("https://p-bandai.com/hk/item/N2362316001004")
